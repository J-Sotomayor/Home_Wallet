        ...
        child: ListView(
          ...
          children: [
            ...
            const _LegalCard(
              ...
              paragraphs: [
                'HomeWallet trata datos de cuenta y contacto, pertenencia y rol en el hogar, información financiera que registras, identificadores técnicos del dispositivo, preferencias, foto opcional y diagnósticos de fallos necesarios para operar y proteger el servicio.',
                'Las finalidades son autenticarte, sincronizar tu hogar, calcular saldos y planes, importar o exportar datos cuando lo solicitas, enviar avisos que habilitas, prevenir abuso, resolver fallos y atender la eliminación de la cuenta.',
            ...
            const _LegalCard(
              ...
              paragraphs: [
                ...
                'Eliminar un movimiento cambia los saldos y el avance relacionado para todos los integrantes del hogar y no se puede deshacer. La aplicación solicita confirmación antes de hacerlo.',
              ],
            ),
            const SizedBox(height: 14),
            const _LegalCard(
              icon: Icons.child_care_outlined,
              title: 'Hogares con menores',
              paragraphs: [
                ...
                'El propietario del hogar es responsable de invitar al menor, asignar su rol y contar con la autorización que corresponda. No deben cargarse datos innecesarios o sensibles del menor.',
              ],
            ),
            const SizedBox(height: 14),
            const _LegalCard(
